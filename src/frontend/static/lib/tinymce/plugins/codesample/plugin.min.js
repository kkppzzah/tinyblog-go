    ...
    const s = "undefined" != typeof window ? window : Function("return this;")()
      , r = function(e, t, n) {
        ...
        var s = function(e) {
              ...
              , s = {
                ...
                util: {
                    ...
                    setLanguage: function(e, n) {
                        ...
                        e.setAttribute("data-prismjs-copy", "Copy")
                    },
                    ...
                    DFS: function e(t, n, a, r) {
                        ...
                        for (var o in t)
                            if (t.hasOwnProperty(o)) {
                                ...
                                var l = t[o]
                                  , u = s.util.type(l);
                                "Object" !== u || r[i(l)] ? "Array" !== u || r[i(l)] || (r[i(l)] = !0,
                                e(l, n, o, r)) : (r[i(l)] = !0,
                                e(l, n, null, r))
                            }
                    }
                ...
                highlightElement: function(t, n, a) {
                    ...
                    l.grammar)
                        if (n && e.Worker) {
                            ...
                            u(s.highlight(l.code, l.grammar, l.language));
                    else
                        u(s.util.encode(l.code))
                },
                highlight: function(e, t, n) {
                    ...
                    if (s.hooks.run("before-tokenize", a),
                    !a.grammar)
                        throw new Error('The language "' + a.language + '" has no grammar.');
                    return a.tokens = s.tokenize(a.code, a.grammar),
                ...
                for (var g in n)
                    if (n.hasOwnProperty(g) && n[g]) {
                        ...
                        for (var b = 0; b < p.length; ++b) {
                            ...
                            for (var v = h.pattern || h, _ = a.next, x = l; _ !== t.tail && !(d && x >= d.reach); x += _.value.length,
                            _ = _.next) {
                                var F = _.value;
                                ...
                                if (!(F instanceof r)) {
                                    var A, S = 1;
                                    if (y) {
                                        if (!(A = i(v, x, e, m)) || A.index >= e.length)
                                            break;
                                        var $ = A.index
                                        ...
                                        if (x = E -= _.value.length,
                                        _.value instanceof r)
                                            continue;
            ...
            ,
            !e.document)
                return e.addEventListener ? (s.disableWorkerMessageHandler || e.addEventListener("message", (function(t) {
        ...
        s.languages.markup.tag.addAttribute(/on(?:abort|blur|change|click|composition(?:end|start|update)|dblclick|error|focus(?:in|out)?|key(?:down|up)|load|mouse(?:down|enter|leave|move|out|over|up)|reset|resize|scroll|select|slotchange|submit|unload|wheel)/.source, "javascript")),
        ...
        s.languages.python["string-interpolation"].inside.interpolation.inside.rest = s.languages.python,
      ...
      , c = e=>t(e) && "PRE" === e.nodeName && -1 !== e.className.indexOf("language-")
      , d = e=>{
      ...
      , g = e=>{
        ...
        ()=>""), (e=>e.value));
        var r;
        const i = ((e,t)=>d(e).fold((()=>t), (e=>{
            const n = e.className.match(/language-(\w+)/);
            return n ? n[1] : t
        }
        )))(e, s)
          , l = (e=>d(e).bind((e=>n.from(e.textContent))).getOr(""))(e);
      ...
      , p = (b = /^\s+|\s+$/g,
    e=>e.replace(b, ""));
    var b, h = tinymce.util.Tools.resolve("tinymce.util.Tools");
    e.add("codesample", (e=>{
        (e=>{
        ...
        (e=>{
            e.on("PreProcess", (t=>{
                ...
                h.each(h.grep(a, c), (e=>{
                    ...
                    let a;
                    for (n.setAttrib(e, "class", p(n.getAttrib(e, "class"))),
                    n.setAttrib(e, "contentEditable", null),
                    n.setAttrib(e, "data-mce-highlighted", null); a = e.firstChild; )
                        e.removeChild(a);
            ...
            e.on("SetContent", (()=>{
                const t = e.dom
                  , n = h.grep(t.select("pre"), (e=>c(e) && "true" !== t.getAttrib(e, "data-mce-highlighted")));
                n.length && e.undoManager.transact((()=>{
                    h.each(n, (n=>{
                        var a;
            ...
            e.on("PreInit", (()=>{
                e.parser.addNodeFilter("pre", (e=>{
                    ...
                    for (let n = 0, a = e.length; n < a; n++) {
                        const a = e[n];
                        -1 !== (null !== (t = a.attr("class")) && void 0 !== t ? t : "").indexOf("language-") && (a.attr("contenteditable", "false"),
