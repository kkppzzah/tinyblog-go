...
const (
	...
	AuthService_GetAuthUserInfo_FullMethodName = "/auth.AuthService/GetAuthUserInfo"
)
...
type AuthServiceClient interface {
	...
	// 获取认证用户信息。
	GetAuthUserInfo(ctx context.Context, in *GetAuthUserInfoRequest, opts ...grpc.CallOption) (*GetAuthUserInfoResponse, error)
}
...
func (c *authServiceClient) GetAuthUserInfo(ctx context.Context, in *GetAuthUserInfoRequest, opts ...grpc.CallOption) (*GetAuthUserInfoResponse, error) {
	out := new(GetAuthUserInfoResponse)
	err := c.cc.Invoke(ctx, AuthService_GetAuthUserInfo_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AuthServiceServer interface {
	...
	// 获取认证用户信息。
	GetAuthUserInfo(context.Context, *GetAuthUserInfoRequest) (*GetAuthUserInfoResponse, error)
}
...
func (UnimplementedAuthServiceServer) GetAuthUserInfo(context.Context, *GetAuthUserInfoRequest) (*GetAuthUserInfoResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetAuthUserInfo not implemented")
}
...
func _AuthService_GetAuthUserInfo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetAuthUserInfoRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AuthServiceServer).GetAuthUserInfo(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AuthService_GetAuthUserInfo_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServiceServer).GetAuthUserInfo(ctx, req.(*GetAuthUserInfoRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var AuthService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _AuthService_GetAuthUserInfo_Handler,
		},
	},
